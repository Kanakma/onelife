...
class TeacherAddHomework extends React.Component{
  ...
  render() {
    return (
      ...
      <div className=" my-content visible-max hidden-middle visible-ipad visible-mobile" hidden={this.state.checkFilter}>
        <div className="row"  >
        { this.state.subjects ? (
      ...
      <div className=" my-content hidden-max-media visible-middle hidden-mobile hidden-ipad" hidden={this.state.checkFilter}>
        <div className="row"  >
        { this.state.subjects ? (
            this.state.subjects.map((subject, s) =>
              <div key={s} className="col-md-4 col-xs-12 col-sm-6" style={{padding: '0px 7.5px'}}>
