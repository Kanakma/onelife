            ...
            <div className="navbar-header">
              <ul className="nav nav-stacked">
                  ...
                  <li><Link to="#" className="waves-effect" name="faculty" onClick={this.changeHide}>
                      <i className="fa fa-university fa-lg icons" name="faculty" aria-hidden="true"></i><Link to="#" name="faculty" onClick={this.changeHide}  className="hidden-menu-style hide-menu ">Факультеты</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="department" onClick={this.changeHide}>
                      <i className="fa fa-building fa-lg icons" aria-hidden="true"></i><Link to="#" className="hidden-menu-style hide-menu " name="department" onClick={this.changeHide}>Кафедры</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="major" onClick={this.changeHide}>
                      <i className="fa fa-mortar-board fa-lg icons" aria-hidden="true" ></i><Link to="#"  name="major" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Специальности</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="group" onClick={this.changeHide}>
                      <i className="fa fa-users fa-lg icons" aria-hidden="true" ></i><Link to="#" className="hidden-menu-style hide-menu " name="group" onClick={this.changeHide}>Группы</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="subject" onClick={this.changeHide}>
                      <i className="fa fa-book fa-lg icons" aria-hidden="true" ></i><Link to="#" name="subject" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Предметы</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="auditory" onClick={this.changeHide}>
                      <i className="fa fa-bandcamp fa-lg icons" aria-hidden="true" ></i><Link to="#" name="auditory" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Аудитории</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="schedule" onClick={this.changeHide}>
                      <i className="fa fa-calendar fa-lg icons" aria-hidden="true" ></i><Link to="#" name="schedule" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Расписание</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="teacher" onClick={this.changeHide}>
                      <i className="fa fa-user-o fa-lg icons" aria-hidden="true" ></i><Link to="#" name="teacher" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Преподаватели</Link>
                  ...
                  <li><Link to="#" className="waves-effect" name="student" onClick={this.changeHide}>
                      <i className="fa fa-user fa-lg icons" aria-hidden="true" ></i><Link to="#" name="student" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Студенты</Link>
                    ...
                    <li><Link to="#" className="waves-effect" name="parrent" onClick={this.changeHide}>
                      <i className="fa fa-blind fa-lg icons" aria-hidden="true" ></i><Link to="#" name="parrent" onClick={this.changeHide} className="hidden-menu-style hide-menu ">Родители</Link>
                  ...
                  <li><Link to="/logout" className="waves-effect"><i className="fa fa-sign-out fa-lg" aria-hidden="true" style={{marginRight: '10px'}}></i><Link to ="/logout" className="hidden-menu-style hide-menu ">Выход</Link></Link></li>
              </ul>
            </div>
          </div>
          </div>
                  ...
                  <ul className="nav nav-stacked">
                      ...
                      <Link to="/" className="waves-effect"><i className="fa fa-home fa-lg icons" aria-hidden="true" ></i><Link to="/" className="hidden-menu-style hide-menu "> Главная</Link></Link></li>
                         ...
                         <li><Link to="#" className="waves-effect" name="attendance" onClick={this.changeHide}>
                          <i className="fa fa-file-text-o fa-lg icons" aria-hidden="true" ></i><Link to="#" name="attendance" className="hidden-menu-style hide-menu " onClick={this.changeHide}>Посещаемость</Link>
                      ...
                      <li><Link to="#" className="waves-effect" name="mark" onClick={this.changeHide}>
                          <i className="fa fa-line-chart fa-lg icons" aria-hidden="true" ></i><Link to="#" name="mark" className="hidden-menu-style hide-menu " onClick={this.changeHide}>Оценки</Link>
                      ...
                      <li><Link to="#" className="waves-effect" name="test" onClick={this.changeHide}>
                          <i className="fa fa-file-text-o fa-lg icons" aria-hidden="true" ></i><Link to="#" name="test" className="hidden-menu-style hide-menu " onClick={this.changeHide}>Тест</Link>
                      ...
                      <li><Link to="#" className="waves-effect" name="homework" onClick={this.changeHide}><i className="fa fa-pencil-square-o fa-lg icons" aria-hidden="true" ></i>
              ...
              <div className="navbar-header">
                <ul className="nav nav-stacked">
                    ...
                    <li><Link to="#" className="waves-effect" name="homework" onClick={this.changeHide}><i className="fa fa-pencil-square-o fa-lg icons" aria-hidden="true" ></i>
                      ...
                      <li><Link to="#" className="waves-effect" name="mark" onClick={this.changeHide}>
                          <i className="fa fa-line-chart fa-lg icons" aria-hidden="true" ></i>
