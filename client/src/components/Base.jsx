            ...
            <div className="navbar-header">
              <ul className="nav nav-stacked">
                  ...
                  <li><Link to="#" className="waves-effect" name="faculty" onClick={this.changeHide}>
                      <i className="fa fa-university fa-lg icons" id="faculty" onClick={this.changeHide} aria-hidden="true"></i><Link to="#" name="faculty" onClick={this.changeHide}  className="hidden-menu-style hide-menu ">Факультеты</Link>
