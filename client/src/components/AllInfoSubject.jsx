              ...
              <div key={s} className="col-md-4 col-xs-12 col-sm-6" style={{padding: '0px 7.5px'}}>
                  ...
                  <div className="white-box">
                      ...
                      {(this.state.status == "admin") ?(
                        <div>
                          <Link to="/" id={subject._id} onClick={this.openSubject} className="btn btn-success btn-rounded waves-effect waves-light m-t-10" style={{color: 'white'}}>Подробнее</Link>
