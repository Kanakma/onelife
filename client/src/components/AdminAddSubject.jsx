            ...
            <h5 style={{marginBottom: '3%'}} className="text-uppercase">Описание предмета</h5>
              ...
              <form action="/" onSubmit={this.addSubject}>
                <div className="form-group">
                    ...
                    <input type="text" className="form-control mydatepicker" placeholder="Код предмета"
                         name="subject_code" value={this.state.subject.subject_code} onChange={this.changeSubject} />
                    <span className="bar"></span>
                </div>
                <div className="form-group">
                    <label>Название предмета</label>
                    <input type="text" className="form-control mydatepicker" placeholder="Название предмета"
                ...
                <div className="col-md-6">
                  <select className="form-control mydatepicker" name="major_id" value={this.state.subject.major_id} onChange={this.changeSubject} disabled={!this.state.checkMajor}>
                ...
                <div className="form-group row">
                <div className="col-md-6">
                  <select className="form-control mydatepicker" name="faculty_id" value={this.state.faculty_name} onChange={this.changeFaculty}>
                ...
                <div className="col-md-6">
                  <select className="form-control mydatepicker" name="teacher_id" value={this.state.subject.teacher_id} onChange={this.changeSubject} disabled={!this.state.checkFaculty}>
                ...
                <div className="form-group row">
                    <div className="col-md-3">
                      ...
                      <input type="number" className="form-control mydatepicker" placeholder="Период"
                             name="period" value={this.state.subject.period} onChange={this.changeSubject} />
                      <span className="bar"></span>
                    </div>
                    <div className="col-md-3">
                      <label>Курс</label>
                      <input type="number" className="form-control mydatepicker" placeholder="Курс"
                             name="course_number" value={this.state.subject.course_number} onChange={this.changeSubject} />
                      <span className="bar"></span>
                    </div>
                    <div className="col-md-3">
                      <label>Кредиты</label>
                      <input type="number" className="form-control mydatepicker" placeholder="Кредиты"
                             name="credit_number" value={this.state.subject.credit_number} onChange={this.changeSubject} />
                      <span className="bar"></span>
                    </div>
                    <div className="col-md-3">
                      <label>Количество студентов</label>
                      <input type="number" className="form-control mydatepicker" placeholder="Количество студентов"
