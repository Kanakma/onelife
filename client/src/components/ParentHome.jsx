...
class ParentHome extends React.Component {
  ...
  componentDidMount() {
    if(Auth.isUserAuthenticated()){
      ...
      axios.get('/api/getstudentforparentprofileinfo?studentId='+decoded.sub,  {
        responseType: 'json',
        headers: {
        ...
        <div className=" col-md-4 col-lg-3 hidden-ipad hidden-mobile hidden-middle visible-max">
          <div className="white-box text-center" style={{height: '388px'}}>
            ...
            <p className="profile-teacher-name">ID{this.state.student.user_id.username}</p>
                ...
                {this.state.pp.map((stud,a) => 
            <div className="student_main_info" key={a} >
              <span className="student_name_main1"> Факуьтет:</span> <span className="student_name_main"> {stud.faculty_id} </span><br/>
          ...
          <div className="white-box text-center" style={{height: '388px'}}>
            <div style={{width: '100%'}}>
              <img src={require("../../../public/student-img/"+this.state.img)} alt="user" className="img-circle img-responsive profile-teacher-img" style={{display: 'block',margin: '10px auto'}}/>
                   ...
                   {this.state.pp.map((stud,b) => 
            <div className="student_main_info" key={b} >
              <p className="profile-teacher-name">{stud.user_id.name} {stud.user_id.lastname}</p>
            <p className="profile-teacher-name">ID {stud.user_id.username}</p>
              <span className="student_name_main1"> ФИО:</span> <span className="student_name_main"> {stud.user_id.name} {stud.user_id.lastname}</span><br/>
               <span className="student_name_main1"> Группа:</span> <span className="student_name_main"> {stud.group_id.group_name}</span><br/>
               <span className="student_name_main1"> Куратор:</span> <span className="student_name_main"> {stud.group_id.curator.user_id.name} {stud.group_id.curator.user_id.lastname}</span><br/>
<span className="student_name_main1"> Тел. Кураторa:</span> <span className="student_name_main"> {stud.group_id.curator.phone}</span><br/>
            </div>
            	)}
        ...
        <div className=" col-md-4 visible-middle hidden-max-media">
          ...
          <div className="student_ocenka_stat">
            ...
            <p className="student_max_score">Средний бал <br/>из максимальных 4.0</p>
            <p className="student_gpa">2.0</p>
            <div className="student_pie_chart">
                 {this.state.pp.map((st,b) => 
            <div key={b} >
            <span className="student_total_gpa">23</span>
            </div>
              )}
