...
var AdminParser = function (_React$Component) {
  ...
  function AdminParser(props) {
    ...
    _this.addStudFile = _this.addStudFile.bind(_this);
    _this.submitStudFile = _this.submitStudFile.bind(_this);
    return _this;
  }

  _createClass(AdminParser, [{
    key: 'addStudFile',
    value: function addStudFile(event) {
      var _this2 = this;
    ...
    key: 'submitStudFile',
    value: function submitStudFile(event) {
      var _this4 = this;

      event.preventDefault();
      return new Promise(function (resolve, reject) {
        var imageFormData = new FormData();
        imageFormData.append('file', _this4.state.sfile);
        _axios2.default.post('/notification/studparser', imageFormData, {
          responseType: 'json',
          headers: {
    ...
    value: function submitFile(event) {
      ...
      return new Promise(function (resolve, reject) {
        var imageFormData = new FormData();
        imageFormData.append('file', _this5.state.file);
        _axios2.default.post('/notification/teachparser', imageFormData, {
          responseType: 'json',
          headers: {
            'Content-type': 'application/x-www-form-urlencoded',
            'Authorization': 'bearer ' + _Auth2.default.getToken()
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'button',
                    { onClick: this.submitFile, disabled: !this.state.uploaded, style: { paddingLeft: '5%', paddingRight: '5%' }, className: 'btn btn-inverse waves-effect waves-light m-r-10' },
                    '\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C'
                  )
                )
              )
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'form-control', 'data-trigger': 'fileinput' },
                  this.state.sfilename.length > 0 ? _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('i', { className: 'glyphicon glyphicon-file fileinput-exists' }),
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  this.state.sfilename.length > 0 ? _react2.default.createElement(
                    'label',
                    { className: 'btn btn-inverse waves-effect waves-light m-r-10' },
                    _react2.default.createElement('input', { style: { display: "none" }, type: 'file', onChange: this.addStudFile }),
                    '\u0418\u0437\u043C\u0435\u043D\u0438\u0442\u044C \u0444\u0430\u0439\u043B'
                  ) : _react2.default.createElement(
                    'label',
                    { className: 'btn btn-inverse waves-effect waves-light m-r-10' },
                  ...
                  _react2.default.createElement(
                    'button',
                    { onClick: this.submitStudFile, disabled: !this.state.suploaded, style: { paddingLeft: '5%', paddingRight: '5%' }, className: 'btn btn-inverse waves-effect waves-light m-r-10' },
                    '\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C'
                  )
                )
              )
